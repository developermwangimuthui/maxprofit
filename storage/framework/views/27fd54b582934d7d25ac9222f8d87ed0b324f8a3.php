...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('/img/'.$settings->site_logo)); ?>" type="image/x-icon"/>
    <!-- Fonts and icons -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/atlantis/style.css')); ?>">

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href="<?php echo e(asset('/atlantis/css/demo.css')); ?>">
    <!-- jquery lib -->
...
<script src="<?php echo e(asset('/atlantis/js/setting-demo.js')); ?>"></script>
<!-- <script src="/atlantis/js/demo.js"></script>    -->
<script src="<?php echo e(asset('/atlantis/js/moment.js')); ?>"></script>
<script src="<?php echo e(asset('/atlantis/main.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\Maxprofit\resources\views/inc/auth_layout.blade.php ENDPATH**/ ?>