...
<body>
    <div style="">
        <img src="<?php echo e(asset('/img/inv_bg2.jpg')); ?>" class="fixedOverlayIMG">
            ...
            <div class="row login_row_cont">
                <div class="col-md-6 position_relative">
                    <div class="logo_cont" align="center">
                        <img src="<?php echo e(asset('/img/'.$settings->site_logo)); ?>" alt="<?php echo e($settings->site_title); ?>" class="login_logo">
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Maxprofit\resources\views/auth/login.blade.php ENDPATH**/ ?>